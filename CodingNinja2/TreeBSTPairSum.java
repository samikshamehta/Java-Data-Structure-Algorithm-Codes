...
public class TreeBSTPairSum {
	...
	{
		ArrayList<Integer>a= PrintNodesSumToS(root);
	...
	public static ArrayList<Integer> PrintNodesSumToS(BinaryTreeNode<Integer> root) 
	{
		if(root==null)
		{
			return null;
		...
		a.add(root.data);
		PrintNodesSumToS(root.left);
		PrintNodesSumToS(root.right);
		Collections.sort(a);
		return a;
	}
}
