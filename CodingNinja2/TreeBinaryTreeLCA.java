...
public class TreeBinaryTreeLCA {
	...
	public static void main(String[] args) 
	{
		...
		int a=s.nextInt();
		int b=s.nextInt();
		int max=lcaBinaryTree(root,a,b);
	...
	public static BinaryTreeNode <Integer> LcaBinaryTree(BinaryTreeNode <Integer> root , int a, int b)
	{
		if(root==null)
		{
			return null;
